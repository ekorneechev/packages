...
%define name zimbra-openjdk
%define OZC /opt/zimbra/common
%define OZCL %OZC/lib
...
%global _jvmdir %{OZCLjvm}
%global _jvmjardir %{OZCLjvm}
%global _jvmprivdir %{OZCLjvm}
...
cd ${RPM_BUILD_ROOT}%{OZCLjvm}
ln -s zimbra-openjdk* java
