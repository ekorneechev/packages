...
Requires:           zimbra-openssl >= 1.0.2l-alt1,zimbra-curl, zimbra-cyrus-sasl, zimbra-rsync
Requires:           zimbra-mariadb-libs >= 10.1.25-alt1, zimbra-openldap-client, zimbra-osl
Requires:           zimbra-prepflog, zimbra-tcmalloc-libs, zimbra-perl-innotop
Requires:           zimbra-openjdk >= 1.8.0u172b01-alt1, zimbra-openjdk-cacerts, zimbra-amavis-logwatch
...
%changelog
* Wed Sep 25 2019 Evgeniy Korneechev <ekorneechev@altlinux.org> 1.0.4-alt1
